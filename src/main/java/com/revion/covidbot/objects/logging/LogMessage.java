...
public class LogMessage {
    ...
    public static final String APP_STARTS = "APP STARTED AT: {}";
    ...
    public static final String BOT_NEW_INPUT_MESSAGE = "Новое сообщение от пользователя: {}, chatId: {}, текст: {}";
    ...
    public static final String REGIONS_NOT_FOUND = "Статистика для отправки не найдена. Пользователь: {}";
    public static final String REGIONS_FOUND = "Найдена статистика для отправки. Пользователь: {}";
    public static final String REGION_INVALID_INPUT = "Неверный ввод региона. Пользователь: {}, текст: {}";
    public static final String REGION_SUCCESSFULLY_UPDATED = "Регион успешно обновлен. Пользователь: {}, регион: {}";
    public static final String REGION_ALREADY_UPDATED = "Регион уже обновлен. Пользователь: {}, регион: {}";

    public static final String USER_NOT_FOUND = "Пользователь не найден. Пользователь: {}";
    ...
    public static final String USER_ALREADY_DELETED = "Пользователь уже удален. Пользователь: {}";
}
